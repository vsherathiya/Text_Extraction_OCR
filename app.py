...
def process_image(file_path):
    try:
        ...
        for data in extracted_data:
            ...
            # Calculate the backg size to match the text
            ...
            backg_color = (255, 255, 255)  # White backg color
